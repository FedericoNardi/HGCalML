...
from datastructures import TrainData_crilin_time, TrainData_crilin
...
if not train.modelSet():
    ...
    if not (isinstance(train.train_data.dataclass(), TrainData_crilin) or isinstance(train.train_data.dataclass(), TrainData_crilin_time)):
